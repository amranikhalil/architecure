...
import architecture from '../hooks/architecture.jpeg'
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col justify-between">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={architecture} // <-- Replace with the correct path to your image
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-6 bg-white/20 backdrop-blur-md rounded-b-2xl mx-4 mt-4 shadow-lg">
        ...
        <div className="hidden md:flex gap-8 text-white/90 font-medium">
          ...
          <Link href="#" className="hover:text-copper transition">Espace Etudiant</Link>
          <Link href="#" className="hover:text-copper transition">Espace Client</Link>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center flex-1 text-center px-4">
        <div className="mt-24 mb-10">
          ...
          <div className="mt-8">
            ...
            <Link href="/" className="inline-block px-8 py-3 rounded-lg bg-copper text-white font-bold text-lg shadow-lg hover:bg-copper-dark transition">Essayez Lumia</Link>
          </div>
        </div>
      </main>
